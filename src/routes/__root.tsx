...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hamduk Chess Club" },
      { name: "description", content: "The official members dashboard for Hamduk Chess Club." },
      { name: "author", content: "Hamduk Chess Club" },
      { property: "og:title", content: "Hamduk Chess Club" },
      { property: "og:description", content: "The official members dashboard for Hamduk Chess Club." },
